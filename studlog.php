	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<form class="login100-form validate-form flex-sb flex-w" method="post" action="stuchk.php" id="index">
...
<!-- 					<div class="flex-sb-m w-full p-b-48">
				...
				<h1 style="text-align: center;color: brown;"><u><a href="register.php"> Register</a></u></h1>
			</div>
		</div>
	</div>
